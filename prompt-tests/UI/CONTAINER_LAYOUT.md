  ...
  **`gap="N"` (numeric):**
  ...
  |-------|----------|----------|
  | `fill` | Expands to fill parent | Full-width sections or Full-height sections |
  ...
  **Common Patterns:**
  ...
  - `width="fill" height="fill"` - Full width and Full Height sections
